...
// var CASE_NUMBER_REGEXP = /(\d[1-9]{4})/;
  ...
  'look-up-case': {
    onEntry: function() {
      if (!validCaseNumber(data.prospectiveCaseNumberVerbatim)) {
        ...
        // } else
        if (CASES[data.prospectiveCaseNumber].phoneMismatch) {
          ...
          data.reportDate = 
              CASES[data.prospectiveCaseNumber].reportDate;
